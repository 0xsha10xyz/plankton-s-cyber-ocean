 ...
 * Same handler as repo-root `api/hive/index.ts` — used when Vercel **Root Directory** is `frontend`.
 * Requires `AGENT_BACKEND_ORIGIN` or `VPS_AGENT_API_ORIGIN` on Vercel.
 */
