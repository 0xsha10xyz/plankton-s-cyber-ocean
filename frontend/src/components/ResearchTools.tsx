...
export default function ResearchTools() {
  ...
  const feedCategories = feeds ?? [
    ...
    { category: "Volume Spikes", items: [{ text: "$PATTIES/SOL", change: "+580%", positive: true, time: "1m ago" }, { text: "$CORAL/USDC", change: "-12%", positive: false, time: "15m ago" }] },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-xl p-6">
        ...
        <div className="flex gap-2 flex-wrap">
          <Input
            placeholder="e.g. PATTIES, CORAL, KRILL"
            value={symbol}
