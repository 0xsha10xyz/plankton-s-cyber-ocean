...
Documentation for **Plankton's Cyber Ocean** — frontend app, backend API, wallet integration, and AI agent.
...
- **Repo structure:** `frontend/` (Vite + React), `backend/` (Express + TypeScript)
